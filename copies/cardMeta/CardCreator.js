export function createCard(scene, x, y, cardData, cardWidth = 60, cardHeight = 90, outlineColor = 0x000000, isFaceUp = false) {
  ...
  // Store card meta information (pileType, pileIndex, positionInPile)
  cardContainer.setData('cardMeta', {
    pileType: 'stockpile',   // Default 'stockpile', can change for tableau, foundation later
    pileIndex: 0,            // Index in the pile
    positionInPile: 0        // Position in the pile (e.g., top card, second card, etc.)
  });
