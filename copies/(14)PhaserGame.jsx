...
const PhaserGame = () => {
  ...
  function create() {
    ...
    this.load.image('card_back', 'src/assets/cards/red_joker.png'); // Assuming the card back image is 'card_back.png'
    ...
    if (i < stockpile.length - 1) { // All but the top card should be facedown
